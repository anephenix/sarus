...
const dataTransformer_js_1 = require("./lib/dataTransformer.js");
...
const getMessagesFromStore = ({ storageType, storageKey, }) => {
    if (constants_js_1.DATA_STORAGE_TYPES.indexOf(storageType) !== -1) {
        const storage = getStorage(storageType);
        const rawData = (storage === null || storage === void 0 ? void 0 : storage.getItem(storageKey)) || null;
        const result = (0, dataTransformer_js_1.deserialize)(rawData);
...
class Sarus {
    constructor(props) {
        ...
        this.url = (0, utils_js_1.validateWebSocketUrl)(url);
    ...
    */
    ...
    set messages(data) {
        ...
        if (constants_js_1.DATA_STORAGE_TYPES.indexOf(storageType) !== -1) {
            const storage = getStorage(storageType);
            if (storage)
                storage.setItem(storageKey, (0, dataTransformer_js_1.serialize)(data));
        }
